...
public class GemController {
	...
	public GemController(App app, Model model, Map<String, Object> input) throws TemplateNotFoundException, MalformedTemplateNameException, ParseException, IOException, TemplateException {
		this.app = app;
		this.model = model;
		this.input = input;
	}
