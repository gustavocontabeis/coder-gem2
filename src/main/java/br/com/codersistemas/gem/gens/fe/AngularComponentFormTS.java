...
public class AngularComponentFormTS {
	
	private App app;
	private Model model;
	private Map<String, Object> input;

	public AngularComponentFormTS(App app, Model model, Map<String, Object> input) throws TemplateNotFoundException, MalformedTemplateNameException, ParseException, IOException, TemplateException {
		this.app = app;
		this.model = model;
		this.input = input;
	}
